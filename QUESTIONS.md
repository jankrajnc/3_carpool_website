...
- In regards to CSS, how do you learn this well or get used to it as a programmer, who doesn't use it much? I'm guessing this is a things that most developers don't deal with often?
    - 2 dela css, ta basic, barve, obroba, pac stil,ipd.; drug del pa so kot neki featuri, recimo pozicioniranje, pa se moras to logiko nauciti, glavne so pozicije pa flexboxi;vedet moras tudi kje je kaj smiselno uporabiti in kako delujejo z drugimi elementi, recimo width v div pa v flexboxu drugace delujeta
CSS knjiznice definirajo spremenljivke ali kaj lahko spreminjas in kako, imas class spremenljivke in tudi v css so spremenljivke; css variables; overridas spemenljivke v svojem css;
ce ni match med bootstrapom pa tvojo kodo, pol kopiras bootstrap element, pa dodas svojo kodo se na vrh, ker je verjetno 80% podobno
